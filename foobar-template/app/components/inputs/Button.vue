<script setup lang="ts">
    ...
    const ButtonBackground = {
        ...
        neutral: `bg-TBD-text-dark/10 dark:bg-TBD-text-light/10 
            text-TBD-text-dark/80 dark:text-TBD-text-light/80
            hover:text-TBD-text-dark dark:hover:text-TBD-text-light`,
    };
    ...
    const ButtonOutline = {
        ...
        neutral: {
            ring: "ring-TBD-text-dark not-disabled:hover:ring-TBD-text-dark dark:ring-TBD-text-light/75 dark:not-disabled:hover:ring-TBD-text-light/75",
            text: "text-TBD-text-dark not-group-disabled:group-hover:text-TBD-text-dark dark:text-TBD-text-light/75 not-group-disabled:dark:group-hover:text-TBD-text-light/75"
        }
    };
</script>
